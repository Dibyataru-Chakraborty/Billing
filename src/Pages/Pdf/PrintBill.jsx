...
export default function PrintBill() {
  ...
  useEffect(() => {
    ...
    if (BillId) {
      ...
      setNetAmountWord(toWords.convert(filteredData.NetAmount, { currency: true }));
      setIGSTAmountWord(toWords.convert(filteredData.IGSTAmount, { currency: true }));
      const uniqueHsns = [
  ...
  //     // Standard-compliant browsers require the return statement
  //     event.returnValue = '';
  //   };
